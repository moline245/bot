...
button = KeyboardButton('Games 🎮')
button1 = KeyboardButton('Profile 👨‍💻 ')
button2 = KeyboardButton('FAQ 📖')
button3 = KeyboardButton('Support 🛎')
ban_button = KeyboardButton('🚫')
kb.add(button,button1,button2,button3)
kb_ban.add(ban_button)

roulette = InlineKeyboardButton('🔴⚫ Roulette' , callback_data = 'roulette')
slots = InlineKeyboardButton('🎰 Slots' , callback_data = 'slots')
dice = InlineKeyboardButton('🎲 Dice' , callback_data = 'dice')
shell = InlineKeyboardButton('📦 shell' , callback_data = 'shell')
basketball = InlineKeyboardButton('🏀 basketball' , callback_data = 'basketball')
darts = InlineKeyboardButton('🎯 darts' , callback_data = 'darts')
bowling = InlineKeyboardButton('🎳 bowling' , callback_data = 'bowling')
football = InlineKeyboardButton('⚽ football' , callback_data = 'football')
apple = InlineKeyboardButton('🍏 apples' , callback_data = 'apples')
coin = InlineKeyboardButton('🪙 coin' , callback_data = 'coin')
jackpot = InlineKeyboardButton('7⃣  jackpot' , callback_data = 'jackpot')
blackjack = InlineKeyboardButton('🃏 blackjack' , callback_data = 'blackjack')
...
withdrawal = InlineKeyboardButton('➖ withdrawal', callback_data='withdrawal')
demo_balance = InlineKeyboardButton('🕹 demobalance_get', callback_data = 'demobalance_get')
demo_balance_on = InlineKeyboardButton('demobalance_on 💵', callback_data = 'demobalance_on')
demo_balance_off = InlineKeyboardButton('demobalance_off 🕹', callback_data = 'demobalance_off')
balance = InlineKeyboardButton('🏦 balance_menu', callback_data='balance_menu')
activate_promo = InlineKeyboardButton('🎫 activate_promo', callback_data='activate_promo')
activate_voucher = InlineKeyboardButton('🎟 activate_voucher', callback_data='activate_voucher')
admin_panel = InlineKeyboardButton('⚙ admin_button', callback_data = 'admin_button')

bet_increase = InlineKeyboardButton('➕', callback_data='bet_increase')
bet_decrease = InlineKeyboardButton('➖', callback_data='bet_decrease')
create_room = InlineKeyboardButton('➕ create_room', callback_data='create_room')
join_room = InlineKeyboardButton('👉 join_room', callback_data = 'join_room')
...
sending_bt = InlineKeyboardButton('mail 📲', callback_data = '')
statistics = InlineKeyboardButton('statistics 📊', callback_data = 'statistics')
users = InlineKeyboardButton('users👥', callback_data = 'users')
output_on = InlineKeyboardButton('output_on✅', callback_data = 'output_on')
output_off = InlineKeyboardButton('output_off❌', callback_data = 'output_off')
promocode = InlineKeyboardButton('promocode 🎫', callback_data = 'promocode')
voucher = InlineKeyboardButton('voucher🎟', callback_data = 'voucher')
...
forms = InlineKeyboardButton('forms 🗂', callback_data = 'forms')

half_money = InlineKeyboardButton('half_money🌓' , callback_data = 'half_money')
all_money = InlineKeyboardButton('all_money 🌕', callback_data = 'all_money')

b52 = InlineKeyboardButton('Попробовать еще раз 🔄' , callback_data = 'bt52')
b53 = InlineKeyboardButton('⬅ bt53' , callback_data = 'bt53')

red = InlineKeyboardButton('🔴' , callback_data = 'red')
black = InlineKeyboardButton('⚫' , callback_data = 'black')
even = InlineKeyboardButton('even' , callback_data = 'even')
odd = InlineKeyboardButton('odd' , callback_data = 'odd')
...
old = InlineKeyboardButton('old 📦', callback_data = 'old')
new = InlineKeyboardButton('new 📲', callback_data = 'new')

user_ban = InlineKeyboardButton('🚫 user_ban ', callback_data = 'user_ban')
user_unban = InlineKeyboardButton('✅ user_unban', callback_data = 'user_unban')
decrease_balance = InlineKeyboardButton('➖ user_decrease_balance', callback_data = 'user_decrease_balance')
increase_balance = InlineKeyboardButton('➕ user_increase_balance', callback_data = 'user_increase_balance')

promocode_create_bt = InlineKeyboardButton('promocode_create 🍾', callback_data = 'promocode_create')
voucher_create_bt = InlineKeyboardButton('voucher_create 🏹', callback_data = 'voucher_create')
promocode_delete_bt = InlineKeyboardButton('promocode_delete 🗑', callback_data = 'promocode_delete')
voucher_delete_kb = InlineKeyboardButton('voucher_delete 🪃', callback_data = 'voucher_delete')
